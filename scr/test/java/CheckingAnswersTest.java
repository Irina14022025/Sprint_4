...
public class CheckingAnswersTest extends BaseTest {
    ...
    public void checkActivity() {
        ...
        homePageSteps.findListQuestion(numberQuestion);
        assertEquals("Ожидаемый ответ отличается от фактического", expectedText, homePageSteps.getActualAnswer(numberQuestion));
